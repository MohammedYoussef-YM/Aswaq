...
class RecentOrderScreen extends StatefulWidget {
  @override
  _RecentOrderScreenState createState() => _RecentOrderScreenState();
}
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color:
                                      ColorResources.COLOR_GREY.withOpacity(0.2),
                                  spreadRadius: 1,
                                  blurRadius: 15,
                                  offset:
                                      Offset(0, 1), // changes position of shadow
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize:
                                              Dimensions.TEXT_SIZE_EXTRA_SMALL,
                                          color: ColorResources.COLOR_GREY,
                                        ),
                                      ),
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            ' ' +
                                                MockData.productList[index].price
                                                    .toString(),
                                            style: TextStyle(
                                                fontSize:
