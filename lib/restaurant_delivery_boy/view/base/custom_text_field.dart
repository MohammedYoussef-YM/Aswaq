...
class CustomTextField extends StatefulWidget {
  ...
  final bool isSearch;
  final RestaurantDeliveryBoyLanguageProvider languageProvider;
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(RestaurantDeliveryBoyDimensions.PADDING_SIZE_EXTRA_SMALL),
          color: Theme.of(context).cardColor,
          border: Border.all(color: widget.isShowBorder ? RestaurantDeliveryBoyColorResources.colorMap[200] : Colors.transparent)),
      child: TextField(
        maxLines: widget.maxLines,
        controller: widget.controller,
        focusNode: widget.focusNode,
        style: Theme.of(context).textTheme.headline2.copyWith(color: Theme.of(context).accentColor, fontSize: RestaurantDeliveryBoyDimensions.FONT_SIZE_LARGE),
