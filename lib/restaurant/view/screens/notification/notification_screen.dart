...
import 'package:flutter_ui_kit/restaurant/view/screens/notification/widget/notification_dialog.dart';
import 'package:provider/provider.dart';

class RestNotificationScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    Provider.of<RestNotificationProvider>(context, listen: false).initNotificationList();
    return Scaffold(
      appBar: CustomAppBar(title: getTranslated('notification', context)),
      body: Consumer<RestNotificationProvider>(
        builder: (context, notificationProvider, child) {
          List<DateTime> _dateTimeList = [];
          return notificationProvider.notificationList != null ? notificationProvider.notificationList.length > 0 ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  ...
                  child: Column(
                    ...
                    children: [
                      _addTitle ? Padding(
                        padding: EdgeInsets.only(top: Dimensions.PADDING_SIZE_SMALL, bottom: 2, left: Dimensions.PADDING_SIZE_SMALL),
