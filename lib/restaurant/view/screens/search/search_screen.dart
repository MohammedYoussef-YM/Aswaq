...
import 'package:flutter_ui_kit/restaurant/view/screens/search/search_result_screen.dart';
                        ...
                        child: CustomTextField(
                          ...
                          onSubmit: (text) {
                            if (_searchController.text.length > 0) {
                              ...
                              searchProvider.searchProduct(_searchController.text);
                  ...
                  Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => InkWell(
                              onTap: () {
                                searchProvider.searchProduct(searchProvider.historyList[index]);
