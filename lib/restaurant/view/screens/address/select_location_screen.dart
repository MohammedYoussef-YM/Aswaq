...
class _SelectLocationScreenState extends State<SelectLocationScreen> {
  ...
  Widget build(BuildContext context) {
    if (Provider.of<RestLocationProvider>(context).address != null) {
      _locationController.text = '${Provider.of<RestLocationProvider>(context).address.featureName ?? ''} '
          '${Provider.of<RestLocationProvider>(context).address.subAdminArea ?? ''} '
          '${Provider.of<RestLocationProvider>(context).address.countryCode ?? ''}';
    }
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_LARGE, vertical: 47.0),
                    child: CustomButton(
