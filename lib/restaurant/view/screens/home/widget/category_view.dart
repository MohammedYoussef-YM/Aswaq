...
import 'package:flutter_ui_kit/restaurant/view/screens/category/category_screen.dart';
...
class CategoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<RestCategoryProvider>(
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: Shimmer.fromColors(
              ...
              enabled: Provider.of<RestCategoryProvider>(context).categoryList == null,
              child: Column(children: [
                Container(
                  height: 65, width: 65, 
