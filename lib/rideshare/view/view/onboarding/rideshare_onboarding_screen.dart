...
import 'package:flutter_ui_kit/rideshare/view/view/auth/welcome_screen.dart';
import 'package:provider/provider.dart';
import 'package:syncfusion_flutter_gauges/gauges.dart';

class RideShareOnboardingScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    Provider.of<RideShareOnBoardingProvider>(context, listen: false).initializeBoardingList();
    Provider.of<RideShareOnBoardingProvider>(context, listen: false).changeOnboardingIndex(0);
    PageController controller = PageController(viewportFraction: 1, keepPage: true);
    return Scaffold(
      backgroundColor: ColorResources.COLOR_WHITE,
      body: Consumer<RideShareOnBoardingProvider>(
