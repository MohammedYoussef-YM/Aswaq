      ...
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: poppinsRegular.copyWith(color: ColorResources.COLOR_GRAY.withOpacity(.7), fontSize: Dimensions.FONT_SIZE_LARGE),
        ...
        Container(
          height: 2,
          color: widget.isBorder?ColorResources.COLOR_PRIMARY:Colors.transparent,
        )
      ],
    );
  }
