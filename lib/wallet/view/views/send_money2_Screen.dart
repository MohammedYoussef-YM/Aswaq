...
import 'package:flutter_ui_kit/wallet/view/views/send_money3_screen.dart';
...
class _SendMoneyScreen2State extends State<SendMoneyScreen2> {
  ...
  Widget build(BuildContext context) {
    return SendMoneyWidget(title: Strings.SEND_MONEY_OTP, child: Column(
      ...
      children: [
        ...
        Text(
          ...
          style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: ColorResources.COLOR_DIM_GRAY),
        )
      ],
    ));
  }
