...
import 'package:flutter_ui_kit/wallet/data/repository/loan_data.dart';
...
import 'package:flutter_ui_kit/wallet/view/widgets/loan_card_widget.dart';
          ...
          Container(
            ...
            child: Column(
              children: [
                Container(
                  padding:
                  EdgeInsets.only(left: 30, top: 18, right: 30, bottom: 13),
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        Strings.DOLLER_3663,
                        style: poppinsSemiBold.copyWith(color: ColorResources.COLOR_PRIMARY_DARK,fontSize: Dimensions.FONT_SIZE_LARGE,),
                      ),
                      SizedBox(
                        height: 20,
                      ),
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(20),
                                    color: ColorResources.COLOR_NEON_CARROT),
                                child: Text(
                                  Strings.BUSINESS,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            Image.asset(
                              'assets/wallet/Icon/health 2.png',
                              width: 52,
                              height: 52,
                              fit: BoxFit.scaleDown,
                            ),
                        ...
                        Column(
                          children: [
                            Image.asset(
                              'assets/wallet/Icon/education2.png',
                              width: 52,
                              height: 52,
                              fit: BoxFit.scaleDown,
                            ),
