                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Text(Strings.TO, style: montserratSemiBold.copyWith(
                        ...
                        Expanded(
                          child: Container(
                            alignment: Alignment.center,
                            child: Text(Strings.SELECT_PAYEE_NAME, style: montserratSemiBold.copyWith(
                              fontSize: Dimensions.FONT_SIZE_SMALL,
                              color: ColorResources.COLOR_WHITE,
                            )),
                          ),
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Image.asset('assets/wallet/Icon/recipt.png', width: 22, height: 25, fit: BoxFit.fill),
                                SizedBox(width: 10),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Image.asset('assets/wallet/Icon/saved account.png', width: 22, height: 25, fit: BoxFit.fill),
                                SizedBox(width: 10),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/electricity.png'),
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/tv.png'),
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/gass.png'),
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/water.png'),
                          ],
                        ),
                        SizedBox(height: 10),
                        Row(
                          children: [
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/telephn.png'),
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/education.png'),
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/health.png'),
                            IconSquareButton(iconUrl: 'assets/wallet/Icon/internet.png'),
                          ],
                        )
                      ],
                    ),
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
        ...
        child: Image.asset(iconUrl, width: 30, height: 30),
      ),
    );
  }
}
