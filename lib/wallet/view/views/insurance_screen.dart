            ...
            child: Stack(
              children: [
                Container(
                  ...
                  child: Image.asset(
                    'assets/wallet/Illustration/insurance.png',
                    width: 140,
                    height: 140,
                  ),
                ),
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: 25,
                                decoration:
                                    BoxDecoration(borderRadius: BorderRadius.circular(9), color: ColorResources.COLOR_GAINS),
                                child: Text(
                                  Strings.VEHICLE,
                                  style: poppinsRegular.copyWith(
                                    fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height: 25,
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(9), color: ColorResources.COLOR_DARK_ORCHID),
                                child: Text(
                                  Strings.HOME,
                                  style: poppinsRegular.copyWith(
                                    fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL,
