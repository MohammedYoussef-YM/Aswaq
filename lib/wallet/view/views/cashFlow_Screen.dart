                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: poppinsSemiBold.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.COLOR_PRIMARY_DARK),
                            ),
                            SizedBox(
                              height: 10,
                            ),
                            Container(
                              height: 30,
                              decoration:
                              BoxDecoration(borderRadius: BorderRadius.circular(20), color: ColorResources.COLOR_WHITE_SMOKE),
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(20), color: ColorResources.COLOR_PRIMARY_DARK),
                                      child: Text(
                                        Strings.EARNED,
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      padding: EdgeInsets.only(left: 16),
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(20), color: ColorResources.COLOR_DARK_ORCHID),
                                      child: Text(
                                        Strings.SPENT,
                                        style: poppinsRegular.copyWith(
                                            color: ColorResources.COLOR_WHITE, fontSize: Dimensions.FONT_SIZE_SMALL),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Image.asset(
                                        'assets/wallet/Icon/transport.png',
                                        width: 52,
                                        height: 52,
                                  ...
                                  Column(
                                    children: [
                                      Image.asset(
                                        'assets/wallet/Icon/utility.png',
                                        width: 52,
                                        height: 52,
                                        fit: BoxFit.scaleDown,
                                      ),
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Text(
                                        Strings.USD426,
                                        style: poppinsRegular.copyWith(
                                            fontSize: Dimensions.FONT_SIZE_SMALL, color: ColorResources.COLOR_WHITE),
                                      ),
                                    ),
                                  ),
                                  Expanded(
