...
class MapWidget extends StatefulWidget {
  ...
  MapWidget({this.currentDeviceLatLng = const LatLng(23.8103, 90.4125), this.destinationLatLng = const LatLng(23.8109, 90.4120)});
...
class _MapWidgetState extends State<MapWidget> {
  ...
  void initState() {
    super.initState();
    //line segment 1
    latLngLists.add(widget.currentDeviceLatLng);
    latLngLists.add(widget.destinationLatLng);
  ...
  void setMarkerAndPolyline() async {
    ...
    Uint8List startCapImageData = await convertAssetToUnit8List('assets/rideshare/images/current_place.png', width: 100);
