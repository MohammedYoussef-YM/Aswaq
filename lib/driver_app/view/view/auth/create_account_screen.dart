...
import 'package:flutter_ui_kit/driver_app/view/view/auth/driverapp_otp_confirmation.dart';
...
class DriverCreateAccountScreen extends StatelessWidget {
            ...
            child: Column(
              children: [
                CustomButton(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => DriverAppConfirmationScreen()));
                  },
                ),
