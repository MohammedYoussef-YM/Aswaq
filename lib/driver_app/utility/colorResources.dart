...
class ColorResources {
  static const Color COLOR_PRIMARY = Color(0xff3986B2);
  static const Color COLOR_PRIMARY_LIGHT = Color(0xffE9FFF2);
  static const Color COLOR_CONFLOWER_BLUE = Color(0xff548CF6);
  static const Color COLOR_ROYAL_BLUE = Color(0xff5554DA);
  static const Color COLOR_ALL_PORTS = Color(0xff1F6C98);
  static const Color COLOR_SIMPLE_BLUE = Color(0xffA6C3FB);
  static const Color COLOR_SEARCH_BACKGROUND = Color(0xffF5F6FA);
  ...
  static const Color COLOR_GRAY_DEEP = Color(0xff303030);
  static const Color COLOR_GRAY_LIGHT = Color(0xff383838);
  static const Color COLOR_GRAY_SIMPLE = Color(0xff242A37);
