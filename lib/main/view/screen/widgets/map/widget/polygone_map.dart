...
class _TrackingMapWidgetState extends State<PolygonMapWidget> {
  ...
  void _setPolygon() {
    ...
    polygonLatLongs.add(LatLng(23.78405369800732, 90.35380321118934));
    polygonLatLongs.add(LatLng(23.781736710381576, 90.35433965298934));
    polygonLatLongs.add(LatLng(23.782934480326716, 90.3558846053733));
