...
class NetworkInfo {
  ...
  static void checkConnectivity(BuildContext context) {
    Connectivity().onConnectivityChanged.listen((ConnectivityResult result) {
      if(Provider.of<SixSplashProvider>(context, listen: false).firstTimeConnectionCheck) {
        Provider.of<SixSplashProvider>(context, listen: false).setFirstTimeConnectionCheck(false);
      }else {
