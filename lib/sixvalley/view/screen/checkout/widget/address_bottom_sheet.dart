              ...
              return profile.addressList != null ? profile.addressList.length != 0 ?  SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        Provider.of<SixOrderProvider>(context, listen: false).setAddressIndex(index);
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: index == Provider.of<SixOrderProvider>(context).addressIndex ? Border.all(width: 2, color: Theme.of(context).primaryColor) : null,
                        ),
                        child: ListTile(
                          leading: Image.asset(
