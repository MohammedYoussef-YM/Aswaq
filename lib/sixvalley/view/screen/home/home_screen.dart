...
import 'package:flutter_ui_kit/sixvalley/view/screen/home/widget/banners_view.dart';
import 'package:flutter_ui_kit/sixvalley/view/screen/home/widget/brand_view.dart';
import 'package:flutter_ui_kit/sixvalley/view/screen/home/widget/category_view.dart';
...
import 'package:flutter_ui_kit/sixvalley/view/screen/flashdeal/flash_deal_screen.dart';
import 'package:flutter_ui_kit/sixvalley/view/screen/search/search_screen.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Provider.of<SixMegaDealProvider>(context, listen: false).initMegaDealList();
                ...
                icon: Stack(clipBehavior: Clip.none, children: [
                  ...
                  Positioned(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Text(Provider.of<SixCartProvider>(context).cartList.length.toString(), style: titilliumSemiBold.copyWith(
              ...
              children: [
                  ...
                  builder: (context, flashDeal, child) {
                    return flashDeal.megaDealList.length > 0 ? Padding(
                      ...
                      child: TitleRow(title: getTranslated('flash_deal', context), eventDuration: flashDeal.megaDealList.length > 0 ? flashDeal.duration : null, onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => SixFlashDealScreen()));
                      }),
                ...
                Padding(
                  ...
                  child: TitleRow(title: getTranslated('brand', context), onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => SixAllBrandScreen()));
                  }),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
