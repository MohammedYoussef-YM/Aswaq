...
class CategoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<SixCategoryProvider>(context, listen: false).initCategoryList();

    return Consumer<SixCategoryProvider>(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Expanded(
              ...
              child: Shimmer.fromColors(
                ...
                enabled: Provider.of<SixCategoryProvider>(context).categoryList.length == 0,
