...
import 'package:flutter_ui_kit/sixvalley/view/screen/setting/widget/currency_dialog.dart';
...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<SixSplashProvider>(context, listen: false).setFromSetting(true);
      ...
      child: CustomExpandedAppBar(title: getTranslated('settings', context), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(child: ListView(
          ...
          children: [
            ...
            SwitchListTile(
              value: Provider.of<SixThemeProvider>(context).darkTheme,
              onChanged: (bool isActive) {
                Provider.of<SixThemeProvider>(context, listen: false).toggleTheme();
            ...
            TitleButton(
              ...
              onTap: () => showAnimatedDialog(context, SixCurrencyDialog(isCurrency: false)),
            ),
            TitleButton(
              image: Images.currency,
              title: '${getTranslated('currency', context)} (${Provider.of<SixSplashProvider>(context).currency.name})',
              onTap: () => showAnimatedDialog(context, SixCurrencyDialog()),
            ),
            /*TitleButton(
