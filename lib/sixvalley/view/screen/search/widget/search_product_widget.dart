...
import 'package:flutter_ui_kit/sixvalley/view/screen/search/widget/search_filter_bottom_sheet.dart';
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  'Search result for \"${Provider.of<SixSearchProvider>(context).searchText}\" (${products.length} items)',
