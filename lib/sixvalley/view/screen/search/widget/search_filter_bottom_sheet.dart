                  ...
                  Padding(
                    ...
                    child: CustomButton(
                      ...
                      onTap: () {
                        ...
                        Provider.of<SixSearchProvider>(context, listen: false).sortSearchList(minPrice, maxPrice);
...
class MyCheckBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CheckboxListTile(
      ...
      value: Provider.of<SixSearchProvider>(context).filterIndex == index,
      onChanged: (isChecked) {
        if(isChecked) {
          Provider.of<SixSearchProvider>(context, listen: false).setFilterIndex(index);
        }
      },
