    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: Consumer<SixCategoryProvider>(
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Provider.of<SixCategoryProvider>(context, listen: false).changeSelectedIndex(index);
                        },
                        child: CategoryItem(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if(index == 0) {
                      ...
                      return Ink(
                        color: Theme.of(context).accentColor,
                        child: Theme(
                          data: Provider.of<SixThemeProvider>(context).darkTheme ? ThemeData.dark() : ThemeData.light(),
                          child: ExpansionTile(
                            key: Key('${Provider.of<SixCategoryProvider>(context).categorySelectedIndex}$index'),
