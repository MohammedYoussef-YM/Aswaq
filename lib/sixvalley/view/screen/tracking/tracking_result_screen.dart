...
import 'package:flutter_ui_kit/sixvalley/view/screen/tracking/painter/line_dashed_painter.dart';
...
class TrackingResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Provider.of<SixTrackingProvider>(context, listen: false).initTrackingInfo(orderID);
    List<String> statusList = [SixAppConstants.PENDING, SixAppConstants.PROCESSING, SixAppConstants.PROCESSED, 'received', SixAppConstants.DELIVERED];
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer<SixTrackingProvider>(
              builder: (context, tracking, child) {
                ...
                return tracking.trackingModel != null
                  ...
                  physics: BouncingScrollPhysics(),
                    ...
                    : status == SixAppConstants.FAILED ? Center(child: Text('Failed')) : status == SixAppConstants.RETURNED ? Center(child: Text('Returned'))
