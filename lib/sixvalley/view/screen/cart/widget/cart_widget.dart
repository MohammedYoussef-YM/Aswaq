    ...
    return Container(
      ...
      child: Row(children: [
        ...
        !fromCheckout ? InkWell(
          onTap: () => Provider.of<SixCartProvider>(context, listen: false).toggleSelected(index),
          child: Container(
            width: 15,
            height: 15,
            ...
            child: Provider.of<SixCartProvider>(context).isSelectedList[index]
        ...
        !fromCheckout ? IconButton(
          onPressed: () => Provider.of<SixCartProvider>(context, listen: false).removeFromCart(index),
    ...
    return InkWell(
      onTap: () {
        if (!isIncrement && quantity > 1) {
          Provider.of<SixCartProvider>(context, listen: false).setQuantity(false, index);
        } else if (isIncrement && quantity < 10) {
          Provider.of<SixCartProvider>(context, listen: false).setQuantity(true, index);
        }
      },
      child: Icon(
