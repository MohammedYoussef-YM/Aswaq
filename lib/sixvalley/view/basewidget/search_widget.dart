...
class SearchWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController _controller = TextEditingController(text: Provider.of<SixSearchProvider>(context).searchText);
            ...
            child: Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Provider.of<SixSearchProvider>(context).searchText.isNotEmpty ? IconButton(
