      ...
      child: Stack(clipBehavior: Clip.none, fit: StackFit.loose, children: [
        ...
        Positioned(
          ...
          child: ClipRRect(
            ...
            child: FadeInImage.assetNetwork(placeholder: Images.placeholder_image, image: Images.login, height: 80, width: 80),
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                Expanded(child: InkWell(
                  onTap: () => Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => SixAuthScreen()), (route) => false),
                  child: Container(
                    padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                    alignment: Alignment.center,
