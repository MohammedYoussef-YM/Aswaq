...
class WishListWidget extends StatelessWidget {
  ...
  WishListWidget({@required this.wishListModel, this.showButton = true, this.isChecked, this.fromCart = false, this.onTap});
      ...
      child: Container(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          fromCart ? Container(
            ...
            child: isChecked ? Icon(Icons.check, size: 20, color: AcademyColorResources.COLOR_PRIMARY) : SizedBox(),
          ) : SizedBox(),
          FadeInImage.assetNetwork(placeholder: Images.place_holder, image: wishListModel.image, width: 80, height: 80, fit: BoxFit.fill),
          SizedBox(width: 10),
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [

              Text(wishListModel.name, maxLines: 2, overflow: TextOverflow.ellipsis, style: robotoMedium.copyWith(
              ...
              Row(children: [
                ...
                Text('${wishListModel.rating}(${wishListModel.totalRating})', style: robotoMedium.copyWith(
                  fontSize: AcademyDimensions.FONT_SIZE_SMALL,
                  color: AcademyColorResources.TITLE_COLOR,
                )),
              ]),

              Text(wishListModel.instructor, style: robotoMedium.copyWith(
                fontSize: AcademyDimensions.FONT_SIZE_SMALL,
                color: AcademyColorResources.TITLE_COLOR,
              )),

              Row(children: [
                Text('BDT ${wishListModel.price}', style: avenirHeavy),
                SizedBox(width: 10),
                Text('BDT ${wishListModel.offPrice}', style: robotoMedium.copyWith(
                  fontSize: AcademyDimensions.FONT_SIZE_SMALL,
                  color: AcademyColorResources.TITLE_COLOR,
                  decoration: TextDecoration.lineThrough,
                )),
              ]),
              SizedBox(height: fromCart ? 0 : showButton ? 10 : 0),

              showButton ? !fromCart ? Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                InkWell(
